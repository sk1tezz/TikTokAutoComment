    ...
    response = g4f.ChatCompletion.create(
        ...
        messages=[
            {"role": "user", "content": (
                ...
                "Важно: не сокращай и не добавляй лишнюю информацию. Просто переформулируй и сделай текст естественным, живым и уникальным. "
                "❗ Ответ должен содержать **только сам преобразованный текст** — без пояснений, кавычек, форматирования, нумерации, префиксов, вводных слов или каких-либо символов до или после. "
