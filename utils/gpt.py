    ...
    response = g4f.ChatCompletion.create(
        ...
        messages=[
            {"role": "user", "content": (
                ...
                "Важно: не сокращай и не добавляй лишнюю информацию. Просто переформулируй и сделай текст естественным, живым и уникальным. В ответ присылай только сам уникализированный текст "
